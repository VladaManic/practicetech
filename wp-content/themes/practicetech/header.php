...
<body <?php body_class(); ?>>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$practicetech_description = get_bloginfo( 'description', 'display' );
			if ( $practicetech_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $practicetech_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'practicetech' ); ?></button>
			<?php
			wp_nav_menu( array(
